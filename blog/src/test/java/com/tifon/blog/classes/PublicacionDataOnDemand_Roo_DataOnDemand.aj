...
privileged aspect PublicacionDataOnDemand_Roo_DataOnDemand {
    ...
    public Publicacion PublicacionDataOnDemand.getNewTransientPublicacion(int index) {
        ...
        setCuerpo(obj, index);
        setFmodificacion(obj, index);
        setFpublicacion(obj, index);
        setResumen(obj, index);
        setTitulo(obj, index);
        return obj;
    }
    
    public void PublicacionDataOnDemand.setCuerpo(Publicacion obj, int index) {
        String cuerpo = "cuerpo_" + index;
        obj.setCuerpo(cuerpo);
    }
    
    public void PublicacionDataOnDemand.setFmodificacion(Publicacion obj, int index) {
        Date fmodificacion = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setFmodificacion(fmodificacion);
    }
    
    public void PublicacionDataOnDemand.setFpublicacion(Publicacion obj, int index) {
        Date fpublicacion = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setFpublicacion(fpublicacion);
    }
    
    public void PublicacionDataOnDemand.setResumen(Publicacion obj, int index) {
        String resumen = "resumen_" + index;
