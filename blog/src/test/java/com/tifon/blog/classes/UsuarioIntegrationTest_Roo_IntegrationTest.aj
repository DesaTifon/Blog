...
import com.tifon.blog.classes.UsuarioDataOnDemand;
import com.tifon.blog.classes.UsuarioIntegrationTest;
...
privileged aspect UsuarioIntegrationTest_Roo_IntegrationTest {
    ...
    public void UsuarioIntegrationTest.testFindUsuario() {
        ...
        Assert.assertEquals("Find method for 'Usuario' returned the incorrect identifier", id, obj.getUsuario_id());
    }
    ...
    public void UsuarioIntegrationTest.testMergeUpdate() {
        ...
        obj.flush();
        Assert.assertEquals("Identifier of merged object not the same as identifier of original object", merged.getUsuario_id(), id);
    ...
    public void UsuarioIntegrationTest.testPersist() {
        ...
        Assert.assertNull("Expected 'Usuario' identifier to be null", obj.getUsuario_id());
        try {
            obj.persist();
        ...
        obj.flush();
        Assert.assertNotNull("Expected 'Usuario' identifier to no longer be null", obj.getUsuario_id());
    }
